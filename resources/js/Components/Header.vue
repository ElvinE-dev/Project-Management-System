    ...
    <div class="w-full flex items-center justify-between h-15 pl-18 bg-white dark:bg-gray-800 shadow-md px-4 py-2">
        <div class="w-full flex gap-5">
            ...
            <div class="w-4/12 flex">
                <button class="w-2/12 h-10 rounded-l-md" >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                    </svg>
                </button>
                <input type="text" placeholder="Type Something..." class="placeholder:text-white text-white w-10/12 h-10 bg-gray-700 rounded-r-md px-4 py-2 outline-none">
            </div>
        </div>
